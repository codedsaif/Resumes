...
import "../app.css";
import resume from "../assets/Saif_Ali_Resume.pdf";
    ...
    >
      ...
      >
        <div
          ...
          className="small-screen hidden mx-10 m "
        >
          <img
            src={mypic}
            alt="profile"
        ...
        <div
          style={{ margin: "auto" }}
          className="flex flex-col justify-center h-full text-center w-full"
        >
          <h2
            className="text-2xl sm:text-sm text-start m-auto font-bold text-white p-2"
            id="fullstack"
          >
          ...
          >
            Self-motivated and a curious learner and creative mind having strong
            in problem-solving and proficiency in HTML, CSS, Javascript, ReactJS
            & Node.js. Seeking a position in a growth-oriented company where I
            can utilize my understanding of coding and software development.
          </p>
